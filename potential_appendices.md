...
Everyone taking this class for credit will be responsible for producing an appendix to the notes on a suggested topic or topic of their choosing.

- For a sense of what I'm looking for, check out [the appendices in these notes](https://tbrazel.github.io/assets/coursenotes/motivic.pdf)
...
## $\Omega_3=0$
Give an overview of Rokhlin's result that the cobordism group of oriented 3-manifolds is trivial [Overview of Rokhlin's work](https://www.math.stonybrook.edu/~oleg/Rokhlin/RokhlinTopologyWorks.html). (Dibs: Luke Lelli)
